"""
Feature extraction and aggregation for student-question level analysis.

This script processes raw submission data to create aggregated features
per student-question pair, including:
- num_attempts: Total number of submission attempts
- avg_edit_distance: Mean Levenshtein distance between consecutive code submissions
- max_pass_ratio: Best pass ratio achieved (proportion of test cases passed)

Input: Raw CSV files (main_data.csv, question_infos.csv, course_infos.csv, section_infos.csv)
Output: nested_analysis.csv with aggregated student-question features
