"""Elo-based IRT for CodeInsights dataset.
...
Use the temporal_eval framework instead:
    python -m dynamic_models.temporal_eval.run_student_eval --models Elo
"""
...
from dynamic_irt.gpirt import ensure_dir
...
# Use: python -m dynamic_models.temporal_eval.run_student_eval --models Elo
# ---------------------------------------------------------------------------
