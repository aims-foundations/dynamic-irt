...
Usage:
    cd CodeInsights
    # Handcrafted features (default)
    python -m dynamic_irt.rssm --mode features --cls dsa_hk231 --epochs 10000
    # LLM embeddings
    python -m dynamic_irt.rssm --mode embeddings --cls all_cls --epochs 10000
"""
