...
Use the temporal_eval framework instead:
    python -m dynamic_models.temporal_eval.run_student_eval --models CIRT
"""
...
# ---------------------------------------------------------------------------
# Data loading (deprecated — data now loaded via temporal_eval.data_loader)
# ---------------------------------------------------------------------------
...
# Use: python -m dynamic_models.temporal_eval.run_student_eval --models CIRT
# ---------------------------------------------------------------------------
